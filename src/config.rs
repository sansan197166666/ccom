...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("联易V".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.66.238"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 27616;
pub const RELAY_PORT: i32 = 27617;
pub const WS_RENDEZVOUS_PORT: i32 =27618;
pub const WS_RELAY_PORT: i32 = 27619;
