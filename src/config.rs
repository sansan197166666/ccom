...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("前沿会".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.66.131"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 30096;
pub const RELAY_PORT: i32 = 30097;
pub const WS_RENDEZVOUS_PORT: i32 =30098;
pub const WS_RELAY_PORT: i32 = 30099;
