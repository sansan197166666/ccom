...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("议聊".to_owned());
...
pub const RENDEZVOUS_PORT: i32 = 26616;
pub const RELAY_PORT: i32 = 26617;
pub const WS_RENDEZVOUS_PORT: i32 =26618;
pub const WS_RELAY_PORT: i32 = 26619;
