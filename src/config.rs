...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.67.116"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 30186;
pub const RELAY_PORT: i32 = 30187;
pub const WS_RENDEZVOUS_PORT: i32 =30188;
pub const WS_RELAY_PORT: i32 = 30189;
