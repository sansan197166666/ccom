...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.68.246"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 51576;
pub const RELAY_PORT: i32 = 51577;
pub const WS_RENDEZVOUS_PORT: i32 =51578;
pub const WS_RELAY_PORT: i32 = 51579;
